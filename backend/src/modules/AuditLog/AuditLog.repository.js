...
class AuditLogRepository {
    // NOTE: Audit_Logs.id is INT AUTO_INCREMENT, do NOT insert manual ID
    ...
    static async createLog(log) {
        ...
        try {
            // Use AUTO_INCREMENT - do NOT specify id column
            ...
            // Log error but DO NOT throw - audit log failure should not crash main operation
